...
const Sidebar = () => {
    ...
    return (
        <div className='fixed w-screen bottom-0 bg-gray-100/30 md:bg-transparent backdrop-blur py-3 shadow-neumorphic md:shadow-none h-auto md:w-fit md:h-screen  md:left-8 z-[999]'>
